  ...
  return (
    <div className="navbar bg-base-100">
        <div className="navbar-start">
            <a href="https://brianconnolly.dev"><img src={logo} className="mx-2 w-28" alt="Brian connolly.dev logo" /></a>
        </div>
        ...
        <div className="navbar-end gap-5 text-3xl p-3 hidden md:flex">
          <a href="https://www.linkedin.com/in/brian-connolly-0b3791b0/" rel="noopener noreferrer" target="_blank">
            <FaLinkedin />
          </a>
